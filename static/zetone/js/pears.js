...
const cantidadEmbalado = async() => {
    try{
        ...
        cantidadEmbalado = `<div class="numeros">CANTIDAD DE CAJAS EMBALADAS: ${cantEmbalado.cantidad}<br> KILOS EMBALADOS APROX: ${cantEmbalado.peso} Kg.</div>`;
...
const cajasEnvasePera = async() => {
    try{
        ...
        if(dataCajasEnvase.message=="Success"){
            cantidadEmbalado();
            //setInterval('cantidadEmbalado()',3000);
